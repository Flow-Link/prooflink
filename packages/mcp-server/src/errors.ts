/**
 * Standardized MCP error response formatting for FlowLink tools.
 *
...
/** Standard error codes used across FlowLink MCP tools. */
export type FlowLinkMcpErrorCode =
  | "VALIDATION_ERROR"
  | "SANCTIONS_MATCH"
  | "SCREENING_FAILED"
